...
function CoverLayout({ title, subtitle, children, className, style }) {
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
    ...
    children: [
      title && /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("h1", {
        style: {
      ...
      subtitle && /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("p", {
        style: {
...
function CenterLayout({ children, className, style }) {
...
function SplitLayout({ left, right, ratio = "50-50", className, style }) {
...
function GridLayout({ children, columns = 2, gap = "md", className, style }) {
  const gridTemplateColumns = typeof columns === "number" ? `repeat(${columns}, 1fr)` : columns.join(" ");
...
function CodeBlock({ code, language, filename, showLineNumbers = false }) {
...
`);
  ...
  return /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
    ...
    children: [
      (filename || language) && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
        style: headerStyle,
        children: [
          filename && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("span", {
            style: { color: "var(--mnestia-text-secondary)" },
            children: filename
          }, undefined, false, undefined, this),
          language && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("span", {
            style: { color: "var(--mnestia-text-muted)", fontSize: "var(--mnestia-font-size-xs)" },
            children: language
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("pre", {
        style: preStyle,
        children: /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("code", {
          children: lines.map((line, i) => /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            style: lineStyle,
            children: [
              showLineNumbers && /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("span", {
...
function Image({ src, alt, caption, objectFit = "contain", className, style }) {
  const containerStyle = {
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
  ...
  return /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("figure", {
    style: containerStyle,
    className,
    children: [
      ...
      caption && /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("figcaption", {
        style: captionStyle,
        children: caption
      }, undefined, false, undefined, this)
    ]
...
function Quote({ quote, author, source }) {
  const containerStyle = {
    position: "relative",
  ...
  return /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("blockquote", {
    style: containerStyle,
    children: [
      ...
      (author || source) && /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("cite", {
        ...
        children: [
          ...
          author,
          source && /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(jsx_dev_runtime8.Fragment, {
            children: [
              author && ", ",
              /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("span", {
...
function Table({ headers, rows, striped = false, className, style }) {
  const containerStyle = {
    width: "100%",
    overflowX: "auto",
    ...style
  ...
  return /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("div", {
    style: containerStyle,
    className,
    children: /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("table", {
      style: tableStyle,
      children: [
        /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("thead", {
          children: /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("tr", {
            children: headers.map((header, i) => /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("th", {
              style: thStyle,
              children: header
            }, i, false, undefined, this))
          }, undefined, false, undefined, this)
        }, undefined, false, undefined, this),
        /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("tbody", {
          children: rows.map((row, rowIndex) => /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("tr", {
            style: striped && rowIndex % 2 === 1 ? { backgroundColor: "var(--mnestia-bg-secondary)" } : undefined,
            children: row.map((cell, cellIndex) => /* @__PURE__ */ jsx_dev_runtime9.jsxDEV("td", {
              style: tdStyle,
              children: cell
...
var theme_base_default = themeBase;
export {
  themeBase,
  setupTheme,
  theme_base_default as default,
  Table,
  SplitLayout,
  Quote,
  Image,
